...
You should download pre-trained VGG-16 named as ```imagenet-vgg-verydeep-16```  from [this link](http://www.vlfeat.org/matconvnet/pretrained/#imagenet-ilsvrc-classification) and put it in cloned folder.
